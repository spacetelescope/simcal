...
xml_file = get_bigdata("simcal/jwst/niriss/wfss/niriss_wfss_example.xml")
pointing_file = get_bigdata("simcal/jwst/niriss/wfss/niriss_wfss_example.pointing")
catalogs = get_bigdata("simcal/jwst/niriss/wfss/niriss_wfss_example.cat")
